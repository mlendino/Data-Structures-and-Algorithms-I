...
//BIGGEST OF THANK YOUS TO ALI RAHMAN FOR USING OPERARTING SYSTEMS GODLY MAGIC TO HELP ME DEBUG MY COLUMN 2 
//AND ALSO FOR TOLERATING MY IDIOCY OF RUNNING THE WRONG .CPP
#include <iostream>
#include <fstream>
#include <sstream>
#include <list>
